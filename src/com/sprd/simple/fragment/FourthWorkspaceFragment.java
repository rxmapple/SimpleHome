...
public class FourthWorkspaceFragment extends Fragment implements AdapterView.OnItemLongClickListener,
    ...
    private static final int ICON_APP_FOLDER = 5;
    ...
    public static FourthPageAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new FourthPageAdapter(getData(), getActivity(), mGridView);
    ...
    private ArrayList getData() {
        ...
        IconInfo folder = new IconInfo();
        folder.setIconName(getResources().getString(R.string.app_folder));
        folder.setIconImage(R.drawable.app_folder);
        list.add(folder);
        ...
        try {
            switch (position) {
                ...
                case ICON_APP_FOLDER:
                    intent = new Intent(getActivity(), BrowserApplicationActivity.class);
                    startActivity(intent);
                default:
                    break;
            }
