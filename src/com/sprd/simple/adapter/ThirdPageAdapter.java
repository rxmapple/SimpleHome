...
public class ThirdPageAdapter extends BaseAdapter {
    ...
    int pm[] = {R.string.call_log_name, R.string.calendar_name, R.string.gallery_name, R.string.fm_name, R.string.clock_name, R.string.settings_name};

    public ThirdPageAdapter(ArrayList<IconInfo> arrayList, Context context, GridView gridView) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mPosition == position) {
            ...
            if (Launcher.mCurrPosition == 2) {
                TextSpeech.read(position, pm, mContext);
                Log.d(TAG, "read() fragment = " + Launcher.mCurrPosition);
            }
        } else {
