...
public class FourthPageAdapter extends BaseAdapter {
    ...
    int pm[] = {R.string.video_name, R.string.music_name, R.string.browser_name, R.string.speed_name, R.string.tools_name, R.string.app_folder};

    public FourthPageAdapter(ArrayList<IconInfo> arrayList, Context context, GridView gridView) {
